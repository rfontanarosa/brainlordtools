...
filename = 'brandish2/roms/Brandish 2 (U) [!].smc'
filename2 = 'brandish2/roms/Brandish 2 (I) [!].smc'
tablename = 'brandish2/tables/Brandish 2 (U) [!].tbl'
tablename2 = 'brandish2/tables/Brandish 2 (I) [!].tbl'
dump_path = 'brandish2/dump/'
user_name = 'clomax'
db = 'brandish2/db/brandish2.db'
