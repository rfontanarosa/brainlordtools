...
def brainlord_text_inserter(args):
    ...
    with open(dest_file, 'r+b') as fw:
        ...
        repoint_two_bytes_pointers(fw, 0x24939, new_pointers, b'\xd7')
        ...
        repoint_two_bytes_pointers(fw, 0x25c88, new_pointers, b'\xd7')
        repoint_two_bytes_pointers(fw, 0x25dd9, new_pointers, b'\xd7')
        repoint_two_bytes_pointers(fw, 0x25e14, new_pointers, b'\xd7')
        repoint_two_bytes_pointers(fw, 0x25fb8, new_pointers, b'\xd7')
