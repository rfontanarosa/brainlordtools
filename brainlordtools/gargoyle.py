...
def main():
    ...
    sub.set_defaults(func=gargoyle_text_dumper)
    ...
    sub.add_argument('-tp1', '--translation_dump_path', action='store', dest='translation_path1', help='Directory containing translation files')
    sub.add_argument('-tp2', '--translation_misc_path', action='store', dest='translation_path2', help='Directory containing translation files')
    sub.set_defaults(func=gargoyle_text_inserter)
    ...
    sub.add_argument('-dp', '--dump_path', action='store', dest='dump_path', help='Output directory for dump files')
    sub.set_defaults(func=gargoyle_misc_dumper)
