...
def main():
    ...
    sub.set_defaults(func=som_text_dumper)
    ...
    sub.set_defaults(func=som_text_inserter)
    ...
    sub.add_argument('-dp', '--dump_path', action='store', dest='dump_path', help='Output directory for dump files')
    sub.set_defaults(func=som_misc_dumper)

    sub = subparsers.add_parser('dump_tilemap', help='Extract tilemap data to binary files')
    sub.add_argument('-s', '--source', action='store', dest='source_file', required=True, help='Source file')
    sub.add_argument('-dp', '--dump_path', action='store', dest='dump_path', required=True, help='Output directory for dump files')
    sub.set_defaults(func=som_tilemap_dumper)

    sub = subparsers.add_parser('insert_tilemap', help='Insert translated tilemap data into the destination ROM')
    sub.add_argument('-d', '--dest', action='store', dest='dest_file', required=True, help='Destination file')
    sub.add_argument('-tp', '--translation_path', action='store', dest='translation_path', required=True, help='Directory containing translation files')
    sub.set_defaults(func=som_tilemap_inserter)
    ...
    sub.add_argument('-t3', '--table3', action='store', dest='table3', help='Tertiary TBL file')
    sub.add_argument('-tp', '--translation_path', action='store', dest='translation_path', help='Directory containing translation files')
    sub.set_defaults(func=som_misc_inserter)
